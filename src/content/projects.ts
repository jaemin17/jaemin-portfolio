...
export const projects: Project[] = [
  {
    ...
    subtitle: "产品设计 / UIUX / 端到端交付（需求、设计、迭代、上架材料）",
    timeframe: "2026",
    role: "独立产品设计师（使用 AI 工具提升效率）",
    tags: ["UIUX", "产品策略", "设计系统", "AI 工作流", "上架交付"],
    highlights: [
      "从 0 定义问题与目标用户，独立输出 PRD + 信息架构 + 原型 + 视觉稿",
      "建立可复用的组件/规范，保证一致性并降低迭代成本",
      "整理上架所需素材（截图、文案、描述）与交接说明，确保可落地",
    ],
    sections: [
      {
        title: "项目概览",
        paragraphs: [
          "这是一个我以“独立交付”为目标的 APP 项目。我把 AI 当作研究、写作、发散与校对的加速器，但关键决策（用户价值、流程取舍、信息层级、视觉一致性）由我主导。",
        ],
      },
      {
        title: "问题与目标",
