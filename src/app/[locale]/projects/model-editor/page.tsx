    ...
    <div className={styles.page} data-page="plain-white">
      ...
      <main>
        ...
        <div className={styles.narrativeSection}>
          <div className={styles.narrativeInner}>
            ...
            <div className={styles.narrativeGrid}>
              ...
              <div className={styles.narrativeBody}>
                <p>
                  面向非专业教师用户，编辑器放弃传统专业工具的高密度小控件范式，转向以"识别优先 + 决策减负"为目标的操作界面设计，因此，我将按钮、工具入口和参数控件做得更大，并强化选中状态，让用户能快速判断<strong className={styles.positioningEmphasis}>当前正在使用哪个工具</strong>。
                </p>
                <p>
                ...
                <div className={styles.narrativeDesignPoints}>
                  ...
                  <ul>
                    ...
                    <li><strong>线性图标</strong>：降低视觉重量，低密度展示</li>
        ...
        <div className={styles.contact}>
          ...
          <Link className="buttonSticker buttonStickerBlue" href={localePath(locale, "/tool")}>
            其他作品
          </Link>
        </div>
